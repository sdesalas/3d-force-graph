...
export default class ForceGraph3D {
	...
	update() {
		...
		const highlightMaterial = new THREE.PointsMaterial( { color: 0xffffff, map: sprite, size: this.nodeRelSize * 1.3, blending: THREE.AdditiveBlending, depthTest: false, transparent : true } );
